# 🚀 PathKhojo — Autonomous Enterprise AI Job & Career Navigator
...
[![Security](https://img.shields.io/badge/Security-0_Vulnerabilities-emerald.svg)](https://pathkhojo.sickykumar.in)

> **PathKhojo** ("पाथ खोजो" — Career Pathway Navigator) is an autonomous, production-grade hiring and career development platform built with high performance, role-isolated architecture, Google Gemini AI integration, real-time meeting automations, modular email systems, and zero cold-start delay engineering.
...
- **Live Platform URL**: [https://pathkhojo.sickykumar.in](https://pathkhojo.sickykumar.in)
- **Author Portfolio & Official Website**: [https://sickykumar.in](https://sickykumar.in)
...
- `authOtp.template.js` — Two-factor authentication & password recovery OTP delivery
- `registrationWelcome.template.js` — Candidate & Recruiter personalized onboarding
- `jobAlert.template.js` — Instant job match alerts
- `newsletterWelcome.template.js` — Weekly curated tech digest welcome
- `recruiterBroadcast.template.js` — Direct candidate skill-match blast
- `contactSupport.template.js` — User acknowledgment & Admin support dispatch
- `loginSecurityAlert.template.js` — Device sign-in notification
...
│   ├── public/                 # Favicons (3D SVG), manifests, robots.txt & sitemap.xml
│   ├── src/
...
| `CLIENT_URL` | Frontend origin for CORS | `https://pathkhojo.sickykumar.in` |
...
PathKhojo — Autonomous Career Intelligence Ecosystem.
